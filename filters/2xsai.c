...
static uint32_t	colorMask = 0, qcolorMask = 0, lowPixelMask = 0, qlowpixelMask = 0;
#else
...
static inline int GetResult (uint32_t, uint32_t, uint32_t, uint32_t);
static inline int GetResult1 (uint32_t, uint32_t, uint32_t, uint32_t, uint32_t);
static inline int GetResult2 (uint32_t, uint32_t, uint32_t, uint32_t, uint32_t);
static inline uint32_t INTERPOLATE (uint32_t, uint32_t);
static inline uint32_t Q_INTERPOLATE (uint32_t, uint32_t, uint32_t, uint32_t);
...
static inline int GetResult1 (uint32_t A, uint32_t B, uint32_t C, uint32_t D, uint32_t E)
{
	int	x = 0, y = 0, r = 0;
...
static inline int GetResult2 (uint32_t A, uint32_t B, uint32_t C, uint32_t D, uint32_t E)
{
	int	x = 0, y = 0, r = 0;
...
void filter_SuperEagle (const uint16_t *p_srcPtr, uint16_t *p_dstPtr, unsigned int width, unsigned int srcRowBytes, unsigned int dstRowBytes, unsigned int height)
{
    ...
    uint32_t	*dP;
    int i;
	uint32_t	nextline = srcRowBytes >> 1;
...
void filter_2xSaI (const uint16_t *p_srcPtr, uint16_t *p_dstPtr, unsigned int width, unsigned int srcRowBytes, unsigned int dstRowBytes, unsigned int height)
{
	...
	for (; height; height--)
	{
		...
		for (i = 0; i < width; i++)
		{
			uint32_t	colorA, colorB, colorC, colorD, colorE, colorF, colorG, colorH, colorI, colorJ, colorK, colorL, colorM, colorN, colorO, colorP;
